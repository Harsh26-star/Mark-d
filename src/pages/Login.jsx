...
function Login() {
    return (
        <div className="min-h-screen bg-gray-200 flex items-center justify-center px-4 md:px-10 lg:px-20">
            ...
            <div className="flex flex-col md:flex-row md:h-124 w-full max-w-5xl">
                ...
                {/* Right Panel */}
                <div className="bg-white w-full md:w-1/2 rounded-2xl md:rounded-none md:rounded-tr-2xl md:rounded-br-2xl flex flex-col p-6 md:p-8">
